...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # Convert the budget to the foreign currency
    exchanged_value = budget / actual_exchange_rate
    
    # Determine the maximum value in terms of the given denomination
    max_value = (exchanged_value // denomination) * denomination
